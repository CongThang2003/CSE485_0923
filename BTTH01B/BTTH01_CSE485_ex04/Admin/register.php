    ...
    <div class="content">
        <div class="form_sign">
            ...
            <div class="body_content">
                <form class="form_sign1" action="execute_register.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-warning ms-5" name="btnRegis">Register</button>
                </form>
            </div>
            <div class="footer_content">
                <div>Do have an account?<a href="">Sign In</a></div>
